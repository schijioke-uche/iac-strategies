...
#Script id:  57634014
#Usage: Helm-tiller Installation for RBAC Enabled Clusters | macOS
...
#Switch Tiller Version
function switchTillerVersion(){
function helmSwitch(){
  echo -e "Switching to the required helm version with tiller..."
